<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="avisolegal.aspx.cs" EnableEventValidation="false" Inherits="WebApplication1.avisolegal" %>
...
>>>>>>> parent of b9a9d23... .
							...
							<div id="content" class="8u skel-cell-important">
								<section>
                                    ...
                                    <span>Bienvenido a nuestro apartado de ayuda al consumidor, en el podra encontrar el apartado de Soporte, Trabaja con nosotros, Privacidad, Aviso Legal y Sugerencias</span>
									</section>
							</div>
									...
									<section>
										<ul class="style">
											...
											<li class="fa fa-leaf">
                                                ...
                                                </br><a href="legal.aspx"><strong>Aviso legal</strong></a>
                                                </span> </li>
										</ul>
									</section>
								</div>
									...
									<section>
										<ul class="style">
											<li class="fa fa-cogs">
                                                ...
                                                </br><a href="Privacidad.aspx"><strong>Privacidad</strong></a></span>
												<li class="fa fa-road">
												<h3>Trabaja con nosotros</h3>
												<span>Si desea trabajar con nosotros, por favor, pinche en este enlace y sera redireccionado a nuestro formulario, el cual
                                                deberá enviarnos a nuestra dirección de correo electrónico servirentweb@gmail.com.
												</br><a href="images/iconos/formulario.png"><strong>Formulario</strong></a></span> </li>
										</ul>
									</section>
								</div>
							</div>
