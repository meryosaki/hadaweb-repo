                    ...
                    <fieldset class="box">
                        ...
                        <ul align="left">
                            ...
                            <li>
                                ...
                                <asp:TextBoxWatermarkExtender ID="NickTextBox" runat="server" TargetControlID="Nick" />
                                    ...
                                    ForeColor="Red" Width="175px"></asp:CustomValidator>
                            ...
                            <li>
                                ...
                                <asp:TextBoxWatermarkExtender ID="NombreTextBox" runat="server" TargetControlID="Nombre" />

                            </li>
                            <li>
                                <label><strong>Dirección de E-mail</strong></label>
                                <asp:TextBox ID="Email" runat="server"></asp:TextBox>
                                <asp:TextBoxWatermarkExtender ID="EmailTextBox" runat="server" TargetControlID="Email" />
                                <asp:FilteredTextBoxExtender ID="FilterEmail" runat="server"  FilterType="Custom , LowercaseLetters , UppercaseLetters" ValidChars=".@" TargetControlID="Email" />
                            </li>
                        </ul>
                        <asp:ConfirmButtonExtender ID="ConfirmButton" runat="server" TargetControlID="ButtonConfirmar" ConfirmText="¿Estas seguro de guardar los cambios?" OnClientCancel="CancelClick" />
                        <asp:Button ID="ButtonConfirmar" runat="server" Text="Confirmar cambios" OnClick="Confirmar" />
